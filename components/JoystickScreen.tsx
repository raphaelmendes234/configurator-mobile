...
export function JoystickScreen() {
  ...
  const drag = Gesture.Pan()
    .onBegin((event) => {
      // Arrêter la rotation quand on touche
    ...
    .onFinalize(() => {
      ...
      // Relancer la rotation quand on relâche
  ...
  // Style pour le conteneur global (Bouton + Texte) qui bouge en X/Y
  ...
  // Style spécifique pour la rotation du texte
